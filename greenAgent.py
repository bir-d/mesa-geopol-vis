...
class greenAgent(mesa.Agent):
    ...
    def talk(self, agent):
        ...
        # elif agent.opinion == self.opinion:
            # self.uncertainty = max(self.uncertainty_interval[0], self.uncertainty * 0.05) # Likeminded people will reduce each others uncertainty, bound by the bottom of the interval.
